...
Date: 2026-07-16
Status: In delivery; CP-000 complete, CP-001 next
Tracking prefix: `CP`
...
| CP-001 | Capability manifest contract | CP-000 | Planned | Versioned manifest, permission, setup, status, action, and renderer schemas |
...
| ID | Work package | Depends on | Status | Deliverable |
| --- | --- | --- | --- | --- |
| CP-003 | Capability registry service | CP-001 | Planned | Provider discovery, capability index, compatibility state, and health aggregation |
...
| ID | Work package | Depends on | Status | Deliverable |
| --- | --- | --- | --- | --- |
| CP-007 | Extensions list and details | CP-004 | Planned | Settings > Advanced list, compatibility, diagnostics, source, version, and capability links |
| CP-008 | Extension lifecycle controls | CP-004, CP-006 | Planned | Admin install, enable, disable, update, remove, repair, and confirmation flows |
...
| ID | Work package | Depends on | Status | Deliverable |
| --- | --- | --- | --- | --- |
| CP-010 | Disk summary contract | CP-000 | Planned | Health, mounted capacity, unused devices, provider assignments, and partial-failure semantics |
