...
Date: 2026-07-20
Status: Planned; local development may begin, but CP-021 must complete before any IL
...
| --- | --- | --- | --- | --- |
| IL-000 | Baseline, ownership, lifecycle and API contract | Approved design | Planned | Recorded current Mattermost/agent/package behavior; frozen public state, blocked-action, tombstone, warning, cleanup-operation, ownership, recovery-credential custody, and rollback contracts |
...
| ID | Work package | Depends on | Status | Deliverable |
| --- | --- | --- | --- | --- |
| IL-002 | Mattermost lifecycle service | IL-001 | Planned | Dependency-gated disable/enable; retained-data uninstall/reinstall; fixed local-image and orphan cleanup; ownership-verified purge behind a default-off server release policy; alert/package-hook cleanup; recovery-secret rotation; tombstone recovery; and status derivation |
